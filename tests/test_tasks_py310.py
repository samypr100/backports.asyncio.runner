...
# Copied from https://github.com/python/cpython/blob/3.10/Lib/test/test_asyncio/test_tasks.py
...
@unittest.skipUnless(
    sys.version_info[:2] == (3, 10), "Skipping as Python Version is not 3.10"
)
class BaseTaskTests:
    Task = None
    Future = None
